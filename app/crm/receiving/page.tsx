    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-cream/50">
          קליטת חשבונית ספק → הוספת מלאי. התאמה אוטומטית לפי קוד ספק. חשבונית שכבר נקלטה לא תיקלט שוב.
          לחשבונית PDF/תמונה — שלחו אותה לקלוד בצ׳אט והוא ימלא את השורות; CSV/Excel אפשר להדביק ישירות.
        </p>
      </div>
