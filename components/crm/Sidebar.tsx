...
import { LayoutDashboard, Users, Sparkles, Ticket, Gift, Instagram, BarChart3, ShoppingBag, ShoppingCart, Star, RotateCcw, Coins, PackageSearch, PackagePlus, Warehouse } from 'lucide-react';

const NAV = [
  { href: '/crm', label: 'סקירה', icon: LayoutDashboard, exact: true },
  { href: '/crm/orders', label: 'הזמנות', icon: ShoppingBag },
  { href: '/crm/inventory-v2', label: 'ניהול מלאי', icon: Warehouse },
  { href: '/crm/inventory-v2/scan', label: 'קליטת חשבונית', icon: PackagePlus },
