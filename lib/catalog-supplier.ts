...
const CAT_ABOUT: Record<string, { short: string; long: string }> = {
  ...
  mezuzot: {
    short: 'בית מזוזה בעיצוב נקי שמשתלב יפה בכל פתח, ומכבד את הקלף שבתוכו.',
    long: 'עשוי בגימור מוקפד ועמיד, נעים למגע ומחזיק מעמד לאורך שנים בכל תנאי מזג אוויר. משתלב יפה בפתחי הבית והעסק. שימו לב: הקלף נמכר בנפרד.',
  },
  'challah-covers': {
