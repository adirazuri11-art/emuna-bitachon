...
// קבועי קטגוריה + טיפוסי בסיס + קבועי קהל/אירועים עברו ל-lib/catalog-constants
// (מודול קליל שגם lib/catalog-lite צורך — מונע גרירת 799 המוצרים אל bundle הלקוח).
import {
  CATEGORIES,
  getCategory,
  AUDIENCE_LABELS,
...
// (StockStatus / ProductBadge / Audience / AUDIENCE_LABELS / OCCASIONS — הוגדרו ב-catalog-constants)
...
// (CustomizationMethod / METHOD_LABELS — הוגדרו ב-catalog-constants)
...
// (STOCK_LABELS / BADGE_LABELS — הוגדרו ב-catalog-constants)
